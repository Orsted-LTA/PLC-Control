export default {
  ...
  batteryOcvStandard: 'OCV Standard',
  ...
  batteryResumeDesc: 'You have an unfinished test session. Do you want to continue or start a new session?',
