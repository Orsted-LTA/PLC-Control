export default {
  ...
  batteryOcvStandard: 'Tiêu chuẩn OCV',
  batteryCcvStandard: 'Tiêu chuẩn CCV',
  batteryOutOfSpec: 'lệch chuẩn',
  batteryRetestRequired: 'Yêu cầu đo lại',
  batteryFillRequiredFields: 'Vui lòng nhập đầy đủ: Mã đơn hàng, Tiêu chuẩn OCV và CCV',
  batteryResumeTitle: 'Phiên đo chưa hoàn thành',
  batteryResumeDesc: 'Bạn có một phiên đo chưa hoàn thành. Bạn muốn tiếp tục hay tạo phiên mới?',
